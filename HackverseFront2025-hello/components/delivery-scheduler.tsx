  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-blue-50 p-4 rounded-md text-blue-800 text-sm">
        ...
        <p>
          Les créneaux sélectionnés indiquent vos disponibilités pour effectuer des livraisons. Le système vous
          attribuera automatiquement des livraisons pendant ces créneaux en fonction de votre emplacement et de votre
          emploi du temps.
        </p>
      </div>
    </div>
